...
$sql="select jawaban from st_pilihan where id = $id";
...
//	}
//	$html .= '<br/>Mau disambungkan dengan staff kami? <a style="color:black; text-decoration: underline;" target="_blank" class="text-black" href="https://web.whatsapp.com/send?phone='.$wa.'&amp;text=Halo%20Sateja%2C%20saya%20mau%20tanya">Customer Service</span></a>';
}
