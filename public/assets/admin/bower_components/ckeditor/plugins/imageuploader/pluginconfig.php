...
$username = "admin"; $password = '21232f297a57a5a743894a0e4a801fc3';
    ...
    $useruploadfolder = "home/web/sites/bions.id/images/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "home/web/sites/bions.id/images/uploads";
    ...
    $useruploadfolder = "assets/admin/bower_components/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "assets/admin/bower_components/ckeditor/plugins/imageuploader/uploads";
