...
//	$row2=mysqli_fetch_assoc($res2);
	...
	$html .= '<br/>Mau disambungkan dengan staff kami? <a style="color:black; text-decoration: underline;" target="_blank" class="text-black" href="https://web.whatsapp.com/send?phone='.$wa.'&amp;text=Halo%20Sateja%2C%20saya%20mau%20tanya">Staff Marketing</span></a>';
}
