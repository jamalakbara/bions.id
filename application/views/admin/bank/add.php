...
?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="BANKID" value="<?php echo set_value('BANKID'); ?>" class="form-control" id="input1" placeholder="BNI">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Nama Bank</label>
                  <div class="col-sm-10">
                    <input type="text" name="BANKNAME" value="<?php echo set_value('BANKNAME'); ?>" class="form-control" id="input1" placeholder="PT. BANK NEGARA INDONESIA">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Bank IDK PEI</label>
                  <div class="col-sm-10">
                    <input type="text" name="BANKIDKPEI" value="<?php echo set_value('BANKIDKPEI'); ?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Reff Bank</label>
                  <div class="col-sm-10">
                    <input type="text" name="REFBANK" value="<?php echo set_value('REFBANK'); ?>" class="form-control" id="input1" placeholder="BNINIDJAXXX">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">CODE</label>
                  <div class="col-sm-10">
                    <input type="text" name="CODE" value="<?php echo set_value('CODE'); ?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">CODE BI</label>
                  <div class="col-sm-10">
                    <input type="text" name="CODE_BI" value="<?php echo set_value('CODE_BI'); ?>" class="form-control" id="input1" placeholder="BNINIDJA">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">MSB ID</label>
                  <div class="col-sm-10">
                    <input type="text" name="MSB_ID" value="<?php echo set_value('MSB_ID'); ?>" class="form-control" id="input1" placeholder="BNI50F">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">CODE ARIA</label>
                  <div class="col-sm-10">
                    <input type="text" name="CODE_ARIA" value="<?php echo set_value('CODE_ARIA'); ?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">No Urut</label>
                  <div class="col-sm-10">
                    <input type="text" name="NOURUT" value="<?php echo set_value('NOURUT'); ?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
                <!--<div class="form-group">
