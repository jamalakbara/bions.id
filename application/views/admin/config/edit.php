...
-->
                ...
                <!--<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Title Shipping (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftitleshipping" value="<?=$config->ftitleshipping?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

				<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Text Shipping (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftextshipping" value="<?=$config->ftextshipping?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Title Guarantee (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftitlegaransi" value="<?=$config->ftitlegaransi?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

				<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Text Guarantee (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftextgaransi" value="<?=$config->ftextgaransi?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Title Open Hour (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftitleopen" value="<?=$config->ftitleopen?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

				<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Text Open Hour (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftextopen" value="<?=$config->ftextopen?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Title Support (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftitlesupport" value="<?=$config->ftitlesupport?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>

				<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Text Support (HOME)</label>
                  <div class="col-sm-10">
                    <input type="text" name="ftextsupport" value="<?=$config->ftextsupport?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>-->

				<div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">WA Number</label>
                  <div class="col-sm-10">
                    <input type="text" name="wa" value="<?=$config->wa?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
...
<?php } ?>
                ...
                <div class="form-group">
                  <label for="input2" class="col-sm-2 control-label">Google Analytics Pixel</label>
                  <div class="col-sm-10">
					<textarea name="g_analitycs" rows="10" cols="80">
                                            <?=$config->g_analitycs?>
                    </textarea>
                  </div>
                </div>
