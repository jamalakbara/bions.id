...
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
<?php
	echo form_open_multipart('admin/referral/edit/'.$referral->id, 'class="form-horizontal"');
?>
              <div class="box-body">
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Referral Name</label>
                  <div class="col-sm-10">
                    <input type="text" name="name" value="<?=$referral->name?>" class="form-control" id="input1" placeholder="ex : Marketing Jakarta">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Referral Slug</label>
                  <div class="col-sm-10">
                    <input type="text" name="slug" value="<?=$referral->slug?>" class="form-control" id="input1" placeholder="ex : marketingjakarta">
                  </div>
                </div>
