        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
				...
				<div class="col-xs-6">
					<a href="<?php echo base_url('admin/menu/add/'); ?>" class="btn btn-primary pull-right" title="Add"><i class="fa fa-edit"></i> Tambah Data</a>
				</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php
		...
		//if(count($childs)==0) {	
?>
				  <a href="<?php echo base_url('admin/menu/edit/'.$crow->id); ?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i> Edit</a> <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default<?=$crow->id?>"><i class="fa fa-trash"></i>Hapus</button>
        <div class="modal fade" id="modal-default<?=$crow->id?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <a href="<?php echo base_url('admin/menu/delete/'.$crow->id); ?>" class="btn btn-primary"><i class="fa fa-trash"></i> Yes, Delete this data!</a>
              </div>
            </div>
          </div>
        </div>
