...
<?php } ?>
                ...
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">App Store & Play Store Text Header</label>
                  <div class="col-sm-10">
                    <input type="text" name="bions" value="<?=$bions->bions?>" class="form-control" id="input1" placeholder="https://link">
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label" for="image1">App Store Image</label>
                  <div class="col-sm-10">
<?php if($bions->appstoreimg) { ?>
				  <img height="80" src="<?php echo base_url().$bions->appstoreimg; ?>"><br/><br/>
<?php } ?>
                  <input type="file" name="appstoreimg" id="image">
				  <input type="hidden" name="old-appstoreimg" value="<?=$bions->appstoreimg?>">
                  <p class="help-block">gif, saran ukuran image 200 x 66 pixel.</p>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label  class="col-sm-2 control-label" for="image1">Play Store Image</label>
                  <div class="col-sm-10">
<?php if($bions->pstoreimg) { ?>
				  <img height="80" src="<?php echo base_url().$bions->pstoreimg; ?>"><br/><br/>
<?php } ?>
                  <input type="file" name="pstoreimg" id="image">
				  <input type="hidden" name="old-pstoreimg" value="<?=$bions->pstoreimg?>">
                  <p class="help-block">gif, saran ukuran image 200 x 66 pixel.</p>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="pstore" value="<?=$bions->pstore?>" class="form-control" id="input1" placeholder="https://link">
                                    ...
                                    <div class="form-group">
										<label for="input1" class="col-sm-2 control-label">Home FAQ Kategori</label>
										<div class="col-sm-10">
		                                <select name="faqid" id="categories" class="select2 form-control custom-select" style="height:36px;">
											<option value="0">Select Kategori</option>
<?php $i = 1; foreach($categories as $row) { 

		if($row->id == $bions->faqid) { $selected = "selected"; } else { $selected = ""; }
