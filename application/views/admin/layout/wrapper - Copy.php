      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/product') ?>"><i class="fa fa-circle-o"></i>Data Product</a></li>
            <li><a href="<?= base_url('admin/product/add') ?>"><i class="fa fa-circle-o"></i>Tambah Product</a></li>
          </ul>
        </li>
