...
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
<?php
	echo form_open_multipart('admin/pilihan/edit/'.$pilihan->id, 'class="form-horizontal"');
?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="pilihan" value="<?=$pilihan->pilihan?>" class="form-control" id="input1" placeholder="Title">
                  </div>
                </div>
                <div class="form-group">
