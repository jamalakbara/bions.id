...
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
<?php
	echo form_open_multipart('admin/chatbot_hints/edit/'.$chatbot_hints->id, 'class="form-horizontal"');
?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="question" value="<?=$chatbot_hints->question?>" class="form-control" id="input1" placeholder="Title">
                  </div>
                </div>
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Reply</label>
                  <div class="col-sm-10">
                    <input type="text" name="reply" value="<?=$chatbot_hints->reply?>" class="form-control" id="input1" placeholder="">
                  </div>
                </div>
