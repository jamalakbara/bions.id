...
<input type="hidden" name="negara" value="<?php if($this->input->post('warganegara') == 'WNI') { echo '01'; } else { echo $this->input->post('negara'); }?>">
...
<input type="hidden" name="otp" value="<?=$this->input->post('otp')?>">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="tempat_lahir" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' placeholder="" maxlength="100" value="<?=$this->input->post('tempat_lahir')?>" required>
    </div>
  </div>
						<div class="form-group row">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input autocomplete="off" class="form-control text-left" type="date" max="<?php echo $tyday; //echo date("Y-m-d"); ?>" name="tanggal_lahir" placeholder="DD-MM-YYYY" value="<?=$this->input->post('tanggal_lahir')?>" required>
								</div>
							</div>
						</div>
  <div class="form-group row">
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="ibu_kandung" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' placeholder="" maxlength="100" value="<?=$this->input->post('ibu_kandung')?>" required>
    </div>
  </div>
    <div class="form-group row">
...
?>
  ...
  <div id="pasangan" class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="nama_pasangan" id="nama_pasangan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' class="form-control" value="<?=$this->input->post('nama_pasangan')?>" maxlength="100" placeholder="">
    </div>
  </div>
<?php if($this->input->post('warganegara') == 'WNI') { ?>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" id="ktp" onkeydown="if(event.key==='.'){event.preventDefault();}" onkeypress='return isnumber(this);' name="ktp" maxlength="16" minlength="16" class="form-control" value="<?=$this->input->post('ktp')?>" placeholder="" <?php if($this->input->post('warganegara') == 'WNI') { echo 'required'; }?>>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Tempat KTP Diterbitkan (Place of issuance)</label>
    <div class="col-sm-8">
      <input type="text" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);charOnly(this.id);"  name="ktp_tempat" id="ktp_tempat" class="form-control" maxlength="100" placeholder="" value="<?=$this->input->post('ktp_tempat')?>" <?php if($this->input->post('warganegara') == 'WNI') { echo 'required'; }?>>
    </div>
  </div>
						<div class="form-group row">
...
?>
								<div style="display:none;" id="ktpberlaku" class="input-group">
									...
									<input autocomplete="off"  class="form-control text-left" type="date" name="ktp_berlaku_tanggal" placeholder="DD-MM-YYYY" value="<?=$this->input->post('ktp_berlaku_tanggal')?>">
								</div>
    </div>
  </div>
                <div class="form-group row">
...
<?php } else { ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="paspor_tempat" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="" value="<?=$this->input->post('paspor_tempat')?>" required>
    </div>
  </div>
						<div class="form-group row">
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="kitas_tempat" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="" value="<?=$this->input->post('kitas_tempat')?>" required>
    </div>
  </div>
						<div class="form-group row">
...
<?php } ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="ktp_alamat" id="ktp_alamat" maxlength="60" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('ktp_alamat')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">RT/RW/Perumahan</label>
    <div class="col-sm-8">
      <input type="text" name="ktp_rtrw" id="ktp_rtrw" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" maxlength="60" value="<?=$this->input->post('ktp_rtrw')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kelurahan (Village)</label>
    <div class="col-sm-8">
      <input type="text" name="ktp_kelurahan" id="ktp_kelurahan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('ktp_kelurahan')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kecamatan (Sub-District)</label>
    <div class="col-sm-8">
      <input type="text" name="ktp_kecamatan" id="ktp_kecamatan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('ktp_kecamatan')?>" required>
    </div>
  </div>
                <div class="form-group row">
				  ...
				  <option value="">Select Provinsi (Province)</option>
<?php $i = 1; foreach($propinsi as $row) { 
		if($this->input->post('ktp_provinceid')) {
			if($row->PROVID == $this->input->post('ktp_provinceid')) { $selected = 'selected'; } else { $selected = ''; }	
		} else { $selected = ''; }									
									?>
                    <option value="<?=$row->PROVID?>" <?=$selected;?>><?=strtoupper($row->PROVNAME)?></option>
<?php $i++; } ?>
                  </select>
                  </div>
                </div>
...
<?php
	if($this->input->post('ktp_cityid')) {
		if($this->input->post('ktp_cityid')) {
			$ktpcity = $this->tabel_model->listdata('st_master_city','PROVID',$this->input->post('ktp_provinceid'));
//			$ktpcity = $this->tabel_model->detail('city',$this->input->post('ktp_cityid'));
			foreach($ktpcity as $row) {
				...
				echo '<option value="'.$row->CITYID.'" '.$selected.'>'.strtoupper($row->CITYNAME).'</option>';
			}
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <!--<input type="number" name="ktp_kodepos" id="ktp_kodepos" class="form-control" value="<?=$this->input->post('ktp_kodepos')?>" placeholder="" required>-->
                  <select name="ktp_kodepos" class="select2 form-control" id="ktp_kodepos" >
				  <option value="">Select Kodepos (Zipcode)</option>
                  </select>
				<!--<div id="ktpziploading" style="margin-top: 15px;">
					<img src="<?=base_url();?>images/loading.gif" width="18"> <small>Loading...</small>
				</div>-->
    </div>
  </div>
  <div class="form-group row">
	  ...
	  <div class="col-sm-8">
      <select id="ktp_negara" name="ktp_negara" class="select2 form-control">
        <option value="">Select</option>
<?php
	foreach($country as $row) {
		if($this->input->post('ktp_negara')) {
			if($row->CTY_ID == $this->input->post('ktp_negara')) { $selected = 'selected'; } else { if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; } }
		} else {
			if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; }
		}
?>
        <option value="<?=$row->CTY_ID?>" <?=$selected?>><?=strtoupper($row->CTY_NAME)?></option>
<?php
	}
?>
      </select>
...
<div id="containerdomisili">
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Jalan (Street Name)</label>
    <div class="col-sm-8">
      <input type="text" name="terkini_alamat" id="terkini_alamat" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('terkini_alamat')?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">RT/RW/Perumahan</label>
    <div class="col-sm-8">
      <input type="text" name="terkini_rtrw" id="terkini_rtrw" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('terkini_rtrw')?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kelurahan (Village)</label>
    <div class="col-sm-8">
      <input type="text" name="terkini_kelurahan" id="terkini_kelurahan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('terkini_kelurahan')?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kecamatan (Sub-District)</label>
    <div class="col-sm-8">
      <input type="text" name="terkini_kecamatan" id="terkini_kecamatan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('terkini_kecamatan')?>">
    </div>
  </div>
                <div class="form-group row">
                  <label for="input1" class="col-sm-4 control-label">Provinsi (Province)</label>
...
<?php $i = 1; foreach($propinsi as $row) { 
		if($this->input->post('terkini_provinceid')) {
			if($row->PROVID == $this->input->post('terkini_provinceid')) { $selected = 'selected'; } else { $selected = ''; }	
		} else { $selected = ''; }										
?>
                    <option value="<?=$row->PROVID?>" <?=$selected;?>><?=strtoupper($row->PROVNAME)?></option>
<?php $i++; } ?>
...
<?php
	if($this->input->post('terkini_cityid')) {
		if($this->input->post('terkini_cityid')) {
			$ktpcity = $this->tabel_model->listdata('st_master_city','PROVID',$this->input->post('terkini_provinceid'));
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <!--<input type="number" name="terkini_kodepos" id="terkini_kodepos" class="form-control" placeholder="" value="<?=$this->input->post('terkini_kodepos')?>">-->
                  <select name="terkini_kodepos" class="select2 form-control" id="terkini_kodepos" >
				  <option value="">Select Kodepos (Zipcode)</option>
                  </select>
    </div>
  </div>
  <div class="form-group row">
      <label class="col-sm-4 col-form-label" for="negara">Negara<br/><i>Country</i></label>
	  <div class="col-sm-8">
      <select id="negara" name="terkini_negara" class="select2 form-control">
        <option value="">Select</option>
<?php
	foreach($country as $row) {
		if($this->input->post('terkini_negara')) {
			if($row->CTY_ID == $this->input->post('terkini_negara')) { $selected = 'selected'; } else { if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; } }
		} else {
			if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; }
		}
?>
...
?>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kode Negara (country area code)</label>
    <div class="col-sm-8">
      <!--<input type="text" name="kode_negara" id="kode_negara" class="form-control" placeholder="+62" value="<?=$this->input->post('phone')?>">-->
      <select id="kode_negara" name="kode_negara" class="select2 form-control">
        <option value="">Select</option>
<?php
	foreach($telpcountry as $row) {
		if($this->input->post('kode_negara')) {
			if($row->CTP_ID == $this->input->post('kode_negara')) { $selected = 'selected'; } else { if($row->CTY_ID == '+62') { $selected = 'selected'; } else { $selected = ''; } }
//		} else {
//			if($row->CTP_ID == '+62') { $selected = 'selected'; } else { $selected = ''; }
		}
?>
        <option value="<?=$row->CTP_ID?>" <?=$selected?>><?=$row->CTP_ID.' : '.strtoupper($row->CTP_NAME)?></option>
<?php
	}
?>
      </select>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kode Area (area code)</label>
    <div class="col-sm-8">
      <!--<input type="text" name="kode_area" id="kode_area" class="form-control" placeholder="021" value="<?=$this->input->post('phone')?>" required>-->
                  <select name="kode_area" class="select2 form-control" id="kode_area" >
				  <option value="">Kode Area (area code)</option>
                  </select>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <select id="investasi" name="investasi" class="select2 form-control">
<?php
...
<div id="alamatperusahaan">
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="" value="<?=$this->input->post('nama_perusahaan')?>" required>
 ...
 <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Jalan (Street Name)</label>
    <div class="col-sm-8">
      <input type="text" name="perusahaan_alamat" id="perusahaan_alamat" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('perusahaan_alamat')?>" required>
	  <i>"jika anda adalah pelajar, maka sebutkan alamat universitas/ if you are a student, please mention your university address"</i>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">RT/RW/Perumahan</label>
    <div class="col-sm-8">
      <input type="text" name="perusahaan_rtrw" id="perusahaan_rtrw" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('perusahaan_rtrw')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kelurahan (Village)</label>
    <div class="col-sm-8">
      <input type="text" name="perusahaan_kelurahan" id="perusahaan_kelurahan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('perusahaan_kelurahan')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Kecamatan (Sub-District)</label>
    <div class="col-sm-8">
      <input type="text" name="perusahaan_kecamatan" id="perusahaan_kecamatan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control" placeholder="" value="<?=$this->input->post('perusahaan_kecamatan')?>" required>
    </div>
  </div>
                <div class="form-group row">
                  <label for="input1" class="col-sm-4 control-label">Provinsi (Province)</label>
...
<?php $i = 1; foreach($propinsi as $row) { 
		if($this->input->post('perusahaan_provinceid')) {
			if($row->PROVID == $this->input->post('perusahaan_provinceid')) { $selected = 'selected'; } else { $selected = ''; }	
		} else { $selected = ''; }										
?>
                    <option value="<?=$row->PROVID?>" <?=$selected;?>><?=strtoupper($row->PROVNAME)?></option>
<?php $i++; } ?>
...
<?php
	if($this->input->post('perusahaan_cityid')) {
		if($this->input->post('perusahaan_cityid')) {
			$ktpcity = $this->tabel_model->listdata('st_master_city','PROVID',$this->input->post('perusahaan_provinceid'));
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <!--<input type="number" name="perusahaan_kodepos" id="perusahaan_kodepos" class="form-control" placeholder="" value="<?=$this->input->post('perusahaan_kodepos')?>" required>-->
                  <select name="perusahaan_kodepos" class="select2 form-control" id="perusahaan_kodepos" >
				  <option value="">Select Kodepos (Zipcode)</option>
                  </select>
 ...
 <!-- <div class="form-group row">
  ...
  <div class="form-group row">
      <label class="col-sm-4 col-form-label" for="negara">Negara<br/><i>Country</i></label>
	  <div class="col-sm-8">
      <select id="perusahaan_negara" name="perusahaan_negara" class="select2 form-control">
        <option value="">Select</option>
<?php
	foreach($country as $row) {
		if($this->input->post('perusahaan_negara')) {
			if($row->CTY_ID == $this->input->post('perusahaan_negara')) { $selected = 'selected'; } else { if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; } }
		} else {
			if($row->CTY_ID == 'INA') { $selected = 'selected'; } else { $selected = ''; }
		}
?>
...
<!-----//////////-->
  ...
  <div id="bidangusaha" class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="bidang_usaha" id="bidang_usaha" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="" value="<?=$this->input->post('bidang_usaha')?>">
    </div>
  </div>
  <div id="inputjabatan" class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="jabatan" id="jabatan" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" placeholder="" value="<?=$this->input->post('jabatan')?>" required>
    </div>
  </div>
  <input type="hidden" name="frekuensi_penghasilan" value="MONTHLY">
  <!--<div class="form-group row">
...
?>
  ...
  <div id="kepemilikanasset" class="form-group row">
...
<div id="opsinpwp">
  <div class="form-group row">
    ...
    <div id="inputnpwp" class="col-sm-8">
      <input type="text" name="npwp" oninput="numberOnly(this.id);" maxlength="15" minlength="15" id="npwp" class="form-control" placeholder="" value="<?=$this->input->post('npwp')?>">
    </div>
  </div>
  <div class="form-group row">
...
?>
  ...
  <div class="form-group row">
	  ...
	  <div class="col-sm-8">
      <select id="nama_bank" name="nama_bank" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="select2 form-control">
        <option value="">Select</option>
<?php 
...
?>
			<option value="<?=$row->BANKID?> <?=$selected?>"><?=strtoupper($row->BANKNAME)?></option>
<?php $i++; } ?>
      </select>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="nama_pemilik" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" id="nama_pemilik" class="form-control" placeholder="" value="<?php if($this->input->post('nama_pemilik')) {  echo $this->input->post('nama_pemilik'); } else { echo $this->input->post('nama_depan').' '.$this->input->post('nama_tengah').' '.$this->input->post('nama_belakang'); } ?>" required>
    </div>
  </div>
  <div class="form-group row">
...
<?php if($this->input->post('rekening_efek') == 'REGULER')  {?>
        <option value="BNI" selected>PT. BANK NEGARA INDONESIA</option>
...
<script>
    function registerpersonalValidation(){
		var ktp_cityid = document.getElementById("ktp_cityid");
		var ktp_provinceid = document.getElementById("ktp_provinceid");
		var terkini_provinceid = document.getElementById("terkini_provinceid");
		var terkini_cityid = document.getElementById("terkini_cityid");
		...
		if(card.selectedIndex == 0) {
			...
			return false;
		} else if(ktp_cityid.selectedIndex == 0) {
			alert('Mohon Pilih Kota (KTP)');
			return false;
		} else if(ktp_provinceid.selectedIndex == 0) {
			alert('Mohon Pilih Kota (KTP)');
			return false;
		} else if(terkini_cityid.selectedIndex == 0) {
			alert('Mohon Pilih Kota (DOMISILI)');
			return false;
		} else if(terkini_provinceid.selectedIndex == 0) {
			alert('Mohon Pilih Kota (DOMISILI)');
			return false;
		} else {
			return true;
