            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="page-title-content">
                        ...
                        <h1 class="title">WEBINAR EVENT</h1>
                    </div>
                </div>
                <!--<div class="col-lg-6">
						...
						<table>
							<tr>
								...
								<td>
									...
									<?=$row->subtext?>
									<a class="main-btn main-btn-2" href="<?=base_url('edukasi/event/'.$row->url)?>">detail</a>
									<!--<a href="<?=base_url('event/register/'.$row->id)?>" class="main-btn main-btn-2">Registrasi</a></p>-->
								</td>
							</tr>
						</table>
                    </div>
