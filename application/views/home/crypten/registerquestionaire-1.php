...
<div id="kuis1">
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="kuis1_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Bagian <i>(Department)</i></label>
    <div class="col-sm-6">
      <input type="text" name="kuis1_bagian" class="form-control" placeholder="">
    </div>
  </div>
</div>
...
<div id="kuis2">
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Nama <i>(Name)</i></label>
    <div class="col-sm-6">
      <input type="text" name="kuis2_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Nama Perusahaan <i>(Company Name)</i></label>
    <div class="col-sm-6">
      <input type="text" name="kuis2_perusahaan" class="form-control" placeholder="">
    </div>
  </div>
</div>
...
<div id="kuis3">
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Nama <i>(Name)</i></label>
    <div class="col-sm-6">
      <input type="text" name="kuis3_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Nama Perusahaan <i>(Company Name)</i></label>
    <div class="col-sm-6">
      <input type="text" name="kuis3_perusahaan" class="form-control" placeholder="">
    </div>
  </div>
</div>
...
<div id="kuis4">
  <div class="form-group row">
  	...
  	<table class="tabeledd">
		...
		<tr>
			<td><input type="text" name="edd_nama1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_tgllahir1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_pekerjaan1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_hubungan1" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="edd_nama2" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_tgllahir2" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_pekerjaan2" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_hubungan2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="edd_nama3" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_tgllahir3" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_pekerjaan3" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_hubungan3" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="edd_nama4" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_tgllahir4" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_pekerjaan4" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_hubungan4" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="edd_nama5" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_tgllahir5" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_pekerjaan5" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_hubungan5" class="form-control" placeholder=""></td>
		</tr>
	</table>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="edd_tinggal" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="edd_owner_a" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">b.</label>
    <div class="col-sm-8">
      <input type="text" name="edd_owner_b" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">c.</label>
    <div class="col-sm-8">
      <input type="text" name="edd_owner_c" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">d.</label>
    <div class="col-sm-8">
      <input type="text" name="edd_owner_d" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">e.</label>
    <div class="col-sm-8">
      <input type="text" name="edd_owner_e" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
  	<table class="tabeledd">
		...
		<tr>
			<td>Gaji / Salary</td>
			<td><input type="number" name="edd_gaji1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_gaji2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td>Investasi / Investment</td>
			<td><input type="number" name="edd_investasi1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_investasi2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td>Dividen / Dividend</td>
			<td><input type="number" name="edd_dividen1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_dividen2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td>Bisnis / Business</td>
			<td><input type="number" name="edd_bisnis1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_bisnis2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td>Lainnya / Others</td>
			<td><input type="number" name="edd_lainnya1" class="form-control" placeholder=""></td>
			<td><input type="text" name="edd_lainnya2" class="form-control" placeholder=""></td>
		</tr>
	</table>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="edd_estimasi" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Tujuan Pembukaan Rekening / Purpose of Account Opening:</label>
    <div class="col-sm-6">
      <input type="text" name="edd_tujuan" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="edd_produk_bni" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">b. Di Perusahaan Sekuritas Lain / At other Securities Company</label>
    <div class="col-sm-6">
      <input type="text" name="edd_produk_lain" class="form-control" placeholder="">
    </div>
  </div>
</div>
...
<div id="kuis5">
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="w9_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Business name/disregarded entity name, if different from above</label>
    <div class="col-sm-6">
      <input type="text" name="w9_bisnis" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
...
<div id="kuis6">
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="w8_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Country of citizenship</label>
    <div class="col-sm-6">
      <input type="text" name="w8_countrycitizen" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="w8_address" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="w8_city" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Country</i></label>
    <div class="col-sm-6">
      <input type="text" name="w8_country" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Mailing address (if different from above)</label>
    <div class="col-sm-6">
      <input type="text" name="w8_mailing" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">City or town, state or province. Include postal code where appropriate</label>
    <div class="col-sm-6">
      <input type="text" name="w8_mailing_city" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Country</label>
    <div class="col-sm-6">
      <input type="text" name="w8_mailing_country" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">U.S. taxpayer identification number (SSN or ITIN), if required</label>
    <div class="col-sm-6">
      <input type="text" name="w8_ssn" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-6 col-form-label">Date of birth (MM-DD-YYYY)</label>
    <div class="col-sm-6">
      <input type="date" name="w8_birth" class="form-control" placeholder="">
    </div>
  </div>
...
<div id="kuis7">
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="pernyataan_nama" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
  	...
  	<table class="tabeledd">
		...
		<tr>
			<td><input type="text" name="pernyataan_pajak1" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_nomor1" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_alasan1" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="pernyataan_pajak2" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_nomor2" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_alasan2" class="form-control" placeholder=""></td>
		</tr>
		<tr>
			<td><input type="text" name="pernyataan_pajak3" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_nomor3" class="form-control" placeholder=""></td>
			<td><input type="text" name="pernyataan_alasan3" class="form-control" placeholder=""></td>
		</tr>
	</table>
  </div>
...
<div id="kuis8">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="manfaat_namapemilik" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="text" name="manfaat_address" class="form-control" placeholder="">
    </div>
  </div>
