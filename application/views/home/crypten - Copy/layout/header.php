                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="<?=base_url()?>"><img src="<?=base_url('assets/home/'.$config->template.'/')?>images/logo.png" alt=""> <img class="logobni" src="<?=base_url('assets/home/'.$config->template.'/')?>images/logobnisek.png" alt=""></a><!-- logo -->
...
?>                                      
                                ...
                                <div class="navbar-btn d-none d-sm-flex">
                                    <a class="main-btn" href="<?=base_url('user/register')?>">Register</a>
                                </div>
                            </nav>
                        </div> <!-- navigation -->
                    </div>
