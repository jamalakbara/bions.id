...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="nama_depan" class="form-control" placeholder="" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Tengah<br><i>Middle Name</i></label>
    <div class="col-sm-8">
      <input type="text" name="nama_tengah" class="form-control" placeholder="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
	  ...
	  <div class="col-sm-8">
      <select id="warganegara" name="warganegara" class="form-control" required>
...
?>
        <option value="<?=$row->iso?>"><?=$row->country_name?></option>
<?php
	}
?>
      </select>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="handphone" class="form-control" placeholder="" required>
    </div>
  </div>
  <div class="form-group row">
      <label class="col-sm-4 col-form-label" for="rekeningefek">Type Rekening Efek<br/><i>(Account Type)</i></label>
	  <div class="col-sm-8">
      <select id="rekeningefek" name="rekening_efek" class="form-control">
  ...
  <div class="form-group row">
	  ...
	  <div class="col-sm-8">
      <select id="service" name="tipe_layanan" class="form-control">
