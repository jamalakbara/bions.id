...
class Botmenu_model extends CI_Model {
		...
		public function listing() {
			$query = $this->db->get('botmenu');
			return $query->result();
		}

		public function getchild($parentid) {
            $this->db->select('*');
            $this->db->from('botmenu');
...
//				echo $this->db->last_query(); die;
		...
		public function add($data) {
			$this->db->insert('botmenu',$data);
		}

		public function edit($data) {
			$this->db->where('id',$data['id']);
			$this->db->update('botmenu',$data);
		}

		public function delete($data) {
			$this->db->where('id',$data['id']);
			$this->db->delete('botmenu',$data);
//			echo $this->db->last_query(); die;
		}
