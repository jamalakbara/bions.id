...
<?php if($bions->button1 OR $bions->button2 ) { ?>
						...
						<?php if($bions->button1) { ?>
                            <li><a class="main-btn" href="<?=$bions->url1?>"><?=$bions->button1?></a></li>
						<?php } ?>
						<?php if($bions->button2) { ?>
                            <li><a class="main-btn main-btn-2" href="<?=$bions->url2?>"><?=$bions->button2?></a></li>
						<?php } ?>
                        </ul>
<?php } ?>
        ...
        <div class="banner-thumb">
            <img src="<?=base_url('assets/home/'.$config->template.'/')?>images/project10.gif" alt="thumb">
        </div>
    </section>