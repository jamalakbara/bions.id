        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
				...
				<div class="col-xs-6">
					<a href="<?php echo base_url('admin/menu/add/'); ?>" class="btn btn-primary pull-right" title="Add"><i class="fa fa-plus"></i> Tambah</a>
				</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php $i = 1; foreach($menu as $row) { ?>
				<tr>
                  ...
                  <td><a href="<?php echo base_url('admin/menu/edit/'.$row->id); ?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i></a> <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default<?=$row->id?>"><i class="fa fa-trash"></i></button>
