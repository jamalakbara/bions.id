...
?>
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
<?php
	echo form_open_multipart('admin/promo/add', 'class="form-horizontal"');
?>
              <div class="box-body">
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Periode</label>
                  <div class="col-sm-10">
                    <input type="text" name="periode" value="<?php echo set_value('periode'); ?>" class="form-control" id="input1" placeholder="Periode">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="input1" class="col-sm-2 control-label">Link Webinar Url</label>
                  <div class="col-sm-10">
