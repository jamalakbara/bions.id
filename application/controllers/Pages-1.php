...
class Pages extends CI_Controller {
	...
	public function index()
	{
		...
		$banner = $this->banner_model->detail(1);
		...
		$data = array(	'title'	=>	$config->site_title,
						...
						'botmenu' => $botmenu,
						'config' => $config,
						'isi'	=>	'pages/'.$config->template.'/pages');

		$this->load->view('pages/'.$config->template.'/layout/wrapper',$data);
	...
	public function detail($id)
	{
		...
		$data = array(	'title'	=>	$config->site_title,
						...
						'botmenu' => $botmenu,
						'config' => $config,
						'isi'	=>	'home/'.$config->template.'/pages');
