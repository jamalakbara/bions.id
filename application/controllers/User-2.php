...
$templine = '';
	...
	{
				$this->db->query("ALTER TABLE `st_registrasi` ADD `kode_negara` VARCHAR(10) NULL AFTER `terkini_negara`, ADD `kode_area` VARCHAR(10) NULL AFTER `kode_negara`");
				$this->db->query("ALTER TABLE `st_city` ADD `code` VARCHAR(5) NULL AFTER `postalcode`");
	}
