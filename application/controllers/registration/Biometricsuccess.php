...
class Biometricsuccess extends Baseregistration {
	...
	public function index()
	{
		...
		$data = array(	'title'	=>	$config->site_title,
				...
				'isi'	=>	'home/'.$config->template.'/registration/12-biometricsuccess'
			);
	...
	public function next(){
		$result = [];
		if(isset($_SESSION['step']) && $_SESSION['step'] == 'biometricsuccess'){
