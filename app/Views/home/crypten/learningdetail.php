				...
				<div class="row align-items-end">
					<div class="col-lg-9">
						<div class="page-title-content">
							...
							<h1 class="title"><?=$learning->title?></h1>
						</div>
					</div>
					<!-- <div class="col-lg-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-8">
                                    <div class="blog-item mt-30" style="height: 100% !important;">
                                        ...
                                        <div class="blog-content text-center" style="height: 57% !important;">
                                            ...
                                            <a href="<?php 
														if ($rel->catid == 1) {
															echo base_url('edukasi/saham/'.$rel->url);
														} else if($rel->catid == 2){
															echo base_url('edukasi/reksadana/'.$rel->url);
														} else if($rel->catid == 3){
															echo base_url('edukasi/fixedincome/'.$rel->url);
														} else if($rel->catid == 4){
															echo base_url('edukasi/video/'.$rel->url);
														}else if($rel->catid == 13){
											        echo base_url('edukasi/marketupdate/'.$rel->url);
									        	}  
													?>"><?=$rel->title?></a>
                                        </div>
                                    </div>
...
<script>
    var metatitle = '<?=$learning->meta_title?>';
    var metadesc = '<?=$learning->meta_desc?>';
