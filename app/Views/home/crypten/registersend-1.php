...
<p class="mb-20">Terima kasih, silahkan cetak dan tandatangan dokumen dibawah ini dan kirim ke :</p>
<p class="mb-20">BNI Sekuritas (Up. Divisi Digital Channel)<br/>
Sudirman Plaza, Indofood Tower lantai 16<br/>
Jl. Jend. Sudirman Kav 76-78<br/>
Jakarta 12910<br/>
call center 14016<br/>
<br/><br/>Jika sebelumnya Anda mendaftarkan rekening BNI sebagai data bank, maka dokumen tersebut tidak perlu dikirim
</p><br/><br/>
<p class="mb-20"><center>Download Formulir dengan klik link dibawah ini<br/>
<a target="_blank" href="<?=base_url('user/viewpdf/'.$lastid->id)?>"><img height="100" src="<?=base_url('images/ipdf.png')?>"></a>
<center>
</p>
                </div>
            </div>
