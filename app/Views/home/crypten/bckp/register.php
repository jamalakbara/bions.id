...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="nama_depan" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' class="form-control" placeholder="" maxlength="35" value="<?=$this->input->post('nama_depan')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Tengah<br><i>Middle Name</i></label>
    <div class="col-sm-8">
      <input type="text" name="nama_tengah" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' maxlength="35" placeholder=""value="<?=$this->input->post('nama_tengah')?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Belakang<br><i>Last Name</i></label>
    <div class="col-sm-8">
      <input type="text" name="nama_belakang" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' maxlength="35" placeholder="" value="<?=$this->input->post('nama_belakang')?>" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-4 col-form-label">Nama Alias<br><i>Nick Name</i></label>
    <div class="col-sm-8">
      <input type="text" name="nama_alias" class="form-control" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" maxlength="35" placeholder="" value="<?=$this->input->post('nama_alias')?>" required>
    </div>
  </div>
  <div class="form-group row">
...
?>
        <option value="<?=$row->NAT_ID?>" <?=$selected;?>><?=strtoupper($row->NAT_DESC)?></option>
<?php
	}
?>
      </select>
...
?>
  ...
  <div class="form-group row">
    <div class="col-sm-4">
        <div class="g-recaptcha" data-sitekey="6LfbivccAAAAAFx9CCeNl1M8bmkz4Yc07pJVdTcr"></div>  
    </div>
  </div>
