...
<form class="col s12">
  <section class="page-area">
   <div class="">
        <h4 class="page-title">Lengkapi Dokumen Pendukung Ya</h4>
          ...
          <div class="col s12">
            <div class="card-panel card-info" style="background: rgba(133, 195, 204, 0.32);">
              ...
              <div class="teal-text text-lighten-1 mt-30">
                Sebelum mulai, ikuti petunjuk berikut ya : <i class="bi bi-align-bottom"></i>
                <div>
                  <div>
                    <div class="dot-arrow">
                  ...
                  <div>
                    ...
                    <div class="info-detail">
                      <span>Siapkan juga tanda tangan terbaik kamu pada selembar kertas putih</span>
                    </div>
                  </div>
    ...
    <div class="row">
        <div class="col s12">
          <a class="waves-effect waves-light btn col s12 white-text btn-attachment">Lanjut</a>
...
<script src="<?=base_url('assets/home/'.$config->template.'/')?>js/registration/10-attachmentguide.js?v=<?= rand() ?>"></script>